...
<div class="form-container">
    ...
    <form method="POST" action="">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select name="tipo" id="tipo" required onchange="toggleCamposExterno()">
                    ...
                    <option value="Interno" <?php echo ($_POST['tipo'] ?? '') === 'Interno' ? 'selected' : ''; ?>>
                        Interno (Realizado pela empresa)
                    </option>
                    <option value="Externo" <?php echo ($_POST['tipo'] ?? '') === 'Externo' ? 'selected' : ''; ?>>
            ...
            <div class="form-group">
                ...
                <select name="status" required>
                    <option value="Programado" <?php echo ($_POST['status'] ?? 'Programado') === 'Programado' ? 'selected' : ''; ?>>
                        Programado
                    </option>
                    <option value="Em Andamento" <?php echo ($_POST['status'] ?? '') === 'Em Andamento' ? 'selected' : ''; ?>>
                        Em Andamento
                    </option>
                    <option value="Executado" <?php echo ($_POST['status'] ?? '') === 'Executado' ? 'selected' : ''; ?>>
                        Executado
                    </option>
                    <option value="Cancelado" <?php echo ($_POST['status'] ?? '') === 'Cancelado' ? 'selected' : ''; ?>>
                        Cancelado
                    </option>
                </select>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea name="observacoes" placeholder="Informações adicionais sobre o treinamento, objetivos, requisitos, etc."><?php echo e($_POST['observacoes'] ?? ''); ?></textarea>
        </div>
