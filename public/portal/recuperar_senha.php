            ...
            if ($colaborador) {
                ...
                if ($resultado['success']) {
                    ...
                    $headers = [
                        ...
                        'From: SGC - Comercial do Norte <noreply@comercialdonorte.com.br>'
                    ];

                    $emailEnviado = mail($email, $assunto, $mensagem, implode("\r\n", $headers));

                    if ($emailEnviado) {
                        $sucesso = "Um email com instruções foi enviado para <strong>$email</strong>. Verifique sua caixa de entrada e spam.";
                        $enviado = true;
                    } else {
                        $erro = "Erro ao enviar email. Entre em contato com o RH.";
                    }
                } else {
        ...
        <div class="recovery-body">
            <?php if (!$enviado): ?>
                ...
                <form method="POST" action="">
                    ...
                    <button type="submit" name="solicitar_reset" class="btn btn-primary">
